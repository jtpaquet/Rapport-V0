...
\begin{table}[htp]
   ...
   \begin{tabular}{|c|c|c|c|c|}
        ...
        Utilisation de l'interface graphique & 5\% & Table \ref{t:bareme_interface} & & \\
        \hline\hline
        Performance & 20\% & & & \\
        \hline
        Précision du logiciel de reconnaissance [\%] & 15\% & Éq. \ref{eq:bareme_precision} & 0 & 100\\
        Précision de la régulation [$\%_\text{écart}$] & 2\% & Éq. \ref{eq:bareme_regul} & $\infty$ & 0\\
        Précision de la mesure de température [$\%_\text{écart}$] & 2\% & Éq. \ref{eq:bareme_precision_temperature} & $\infty$ & 0 \\
        Précision de la mesure du temps [s] & 1\% & Éq. \ref{eq:bareme_precision_temps} & $\infty$ & 0\\ \hline\hline
...
\subsubsection{Taille maximale des spécimens observables}
