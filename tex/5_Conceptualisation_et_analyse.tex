...
\textbf{Description :} Pour communiquer l'alarme avec l'utilisateur, la plateforme Pushover est utilisée. Elle permet d'envoyer des notifications sur des appareils mobiles et s'intègre bien sur une application web. 
...
\subsubsection{Google Chrome Alarms}

\textbf{Description:} Pour communiquer l'alarme avec l'utilisateur, l'API de Google Chrome Alarms est utilisée. Elle permet d'envoyer des notifications l'application web et est optimisée pour une telle application.

\textbf{Décision:} Retenu

\textbf{Justification:} 

\textbf{Références:} \cite{Chrome_Alarm}



\subsubsection{Tizen Alarm API}

\textbf{Description:} Pour communiquer l'alarme avec l'utilisateur, la plateforme Tizen pour applications web serait demandée.

\textbf{Décision:} Retenu.

\textbf{Justification:} 

\textbf{Références:} \cite{Tizen}

\subsubsection{Intégration avec CodeCreators}
...
\scalebox{0.9}{
    ...
    & Physiques & Économiques & Temporels & Socio-envir & \\
    \hline\hline
    Pushover message API & Oui & Oui & Oui & Oui & Retenu\\
    Google Chrome Alarms & Oui & Oui & Oui & Oui & Retenu \\
    Tizen Alarm API & Oui & Oui & Oui & Oui & Retenu \\
    Intégration avec CodeCreators & Oui & Oui & Oui & Oui & Retenu \\
    \hline
    \end{tabular}
}
