...
\ref{Rdc} Résolution du capteur [Mpx]& 5 & 12 & 3 & 2,1 \\ \hline
\ref{Idp} Identification des poissons & 30 & 30 & 30 & 30 \\ \hline
\ref{Vdi} Volume d'analyse [m$^3$] & 1.672 & 1,672 & 19,5 & 4 \\ \hline
\ref{subsection:capacite_stockage} Capacité de stockage [Go] & 20 000 & 240 & 1 000 & 20 000 \\ \hline
\ref{subsection:dureeviealim} Durée de vie de l'alimentation [jours] & 16,33 & $\infty$ & 240 & 16,33 \\ \hline
\ref{Adi} Acheminement des informations [m] & $\infty$ & 76,2 & $\infty$ & $\infty$ \\ \hline
\ref{syssecu} Fiabilité du système de sécurité [couches] & 2 & 2 & 3 & 1 \\ \hline
\ref{Respro} Résistance à la profondeur du capteur [m] & 57,21 & 57,21 & 50 & 150 \\ \hline
\ref{tmdso} Taille minimale des spécimens observés [cm] & 1,36 & 1,82 & 6 & 2,24 \\ \hline
\ref{nombrefonc} Nombre de fonctionnalités liées à l'alarme & 3 & 2 & 1 & 2 \\ \hline
\ref{puisca} Puissance de calcul [\%] & 130 & 71 & 70,4 & 70,4 \\ \hline
\ref{UIG} Utilisation de l'interface graphique & 1 & 0,8 & 0,8 & 0,6 \\ \hline
\ref{s:performance} Performances & & & & \\ \hline
\ref{Pldr} Précision du logiciel de reconnaissance [\%] & 98 & 99 & 80 & 70 \\ \hline
\ref{Ptree} Précision de la régulation de la température [\%] & 99,8 & 99 & 98 & 99 \\ \hline
\ref{Pdlmdt} Précision de la mesure de la température [\%] & 99,8 & 99 & 99 & 99,8 \\ \hline
\ref{Pdlmdtasd} Précision de la mesure du temps [\%] & 100 & 100 & 100 & 100 \\ \hline
\ref{Coutsgloba} Coûts & & & & \\ \hline
\ref{cenmaindo} Coût de main d'oeuvre [\$] & 40 000 & 40 000 & 39 400 & 37 000 \\ \hline
\ref{ccdpsdsfsd} Coût du matériel [\$] & 1647,27 & 2835,69 & 2056,98 & 1426,79 \\ \hline
\end{tabular}}
